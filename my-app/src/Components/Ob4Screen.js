    ...
    <div className="relative">
      ...
      <div className=" text-white">
        ...
        <div
          ...
          style={{
            minHeight: "200vh",
            backgroundImage: `url(${ob4RedCarrier})`,
            backgroundRepeat: "no-repeat",
            backgroundSize: "cover",
          ...
          <div className="grid grid-cols-4 text-white">
            <div className="row-span-1">
              ...
              <p style={{ fontSize: "18px" }}>
                ...
                sound and a stereo field that fills the entire room. a
                flow-optimised bass reflex duct delivers deep natural bass.
              </p>
            </div>
            <div>
              <h2>72 hrs listening</h2>
              <p>
                how about normal radio listening for a week without charging?
                the high capacity lipo battery delivers about 8 hours of noise
                at max volume, or an average of 40 hours on a single charge.
              </p>
            </div>
            <div>
              <h2>the wireless part</h2>
              <p>
                the OB–4 hardware platform supports both high-definition
                bluetooth classic and bluetooth low energy standards. works with
            ...
            <div>
              <h2>smart antenna</h2>
              <p>
                we've spent years fiddling with the antenna so you won't have
                to. and for those tricky listening places, we've included a
                fine-tuned smart spiral antenna that neatly integrates in the
                handle.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-3">
          ...
          >
            ...
            <p>
              zone out to a drone generated by snippets of a radio broadcast.
            </p>
          </div>
          <div
            style={{
        ...
        >
          ...
          <div className="flex  justify-center">
            <p className="w-1/4">
              designed to be played outdoors, in public spaces and at high
              volume; carried on one shoulder with speaker elements facing the
              head. note: it is assumed that passers-by share the same musical
              taste.
            </p>
            <p className="w-1/4">
              or why not give it a home in your kitchen? with any luck, the
              iconic handle makes it a breeze to carry anywhere, and can even be
              used as a stand for a more relaxed listening position.
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex  justify-center">
            <p className="w-1/4">
              ...
              somewhere. or, when you just want to round off the edges of OB–4
              and feel the soft touch of genuine leather.
            </p>
            <p className="w-1/4">
              ultra durable cow hide is hand stitched along four edges for a
              perfectly tailored and acoustically transparent fit. the
              detachable strap can be adjusted to several lengths. each of these
              first edition bags are unique and hand marked with an edition
              number.
            </p>
          </div>
        </div>
